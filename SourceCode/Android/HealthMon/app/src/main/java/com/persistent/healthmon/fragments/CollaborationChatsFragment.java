...
public class CollaborationChatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.collaboration_chats, container, false);

        RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.collaboration_chats_recyclerview);
        processContactList();
    ...
    public CollaborationChatsFragment() {
    }
    ...
    public void processContactList(){
        ...
        Contacts contact = new Contacts("Dr Surekha Joshi MO","Online","Taluka 1");
