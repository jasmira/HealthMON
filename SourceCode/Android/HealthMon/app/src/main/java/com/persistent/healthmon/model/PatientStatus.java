...
public class PatientStatus {
    ...
    public String toString() {
        ...
        return this.patientId + "," + this.hbFlag + "," + this.hbValue + "," + this.bpSysFlag + "," + this.bpSysValue + "," + this.bpDiaFlag + "," + this.bpDiaValue + "," +
                this.bpPulseFlag + "," + this.bpPulseValue + "," + this.weightFlag + "," + this.weightValue + "," + this.oxiPulseFlag + "," + this.oxiPulseValue + "," +
                this.oxiSpO2Flag + "," + this.oxiSpO2Value + "," + this.overallFlag + "," + statusMsg + "," + DateUtil.getCurrentTimeStamp();
    }
}
