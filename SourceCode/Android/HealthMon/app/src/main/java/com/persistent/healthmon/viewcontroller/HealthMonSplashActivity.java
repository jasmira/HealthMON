...
public class HealthMonSplashActivity extends Activity {
    ...
    private void openNextActivity() {
        if (PreferanceManager.getBooleanPreferences("isLoginCheckBoxClicked",false,getApplicationContext())==false) {
            ...
            Intent intent = new Intent(HealthMonSplashActivity.this,HealthMonMainActivity.class);
            startActivity(intent);
            finish();
