...
public class Tasks {
    ...
    public int task_to_show;
    Long date;

    public Tasks() {
    }

    public Tasks(int user_Tasks_id/*, int HM_User_HM_Programs_Programs_id*/, String HM_User_id,
                 ...
                 String HM_Patient_id/*, int HM_Task_id*/, String patient_full_name, Long date,
                 int task_to_show) {
       ...
       // this.HM_Task_id = HM_Task_id;
        ...
        this.date = date;
        this.task_to_show = task_to_show;
    }

    public Tasks(int user_Tasks_id/*, int HM_User_HM_Programs_Programs_id*/, String HM_User_id,
                 String user_Task_Name, String user_Task_Description, String user_Task_Type,
                 String user_Task_Date,
                 Long date,
                 int task_to_show) {
        User_Tasks_id = user_Tasks_id;
        User_Task_Date = user_Task_Date;
    ...
    public int getTask_to_show() {
        return task_to_show;
    }

    public void setTask_to_show(int task_to_show) {
        this.task_to_show = task_to_show;
    }
    ...
    public String getHM_User_id() {
        return HM_User_id;
    }

    public void setHM_User_id(String HM_User_id) {
        this.HM_User_id = HM_User_id;
    }
