...
//        values.put("is_Uploaded", myImmunizations.getIs_Uploaded());
   ...
   /* public void insertPatientProgramInfo(ProgramInfo programInfo) {
      ...
      *//*  values.put("hbFlag", patientStatus.getHbFlag());
        values.put("hbValue", patientStatus.getHbValue());
        values.put("bpFlag", patientStatus.getBpSysFlag());
        values.put("bpSysValue", patientStatus.getBpSysValue());
        // values.put("bpDiaValue", patientStatus.getBpDiaFlag());
        values.put("bpDiaValue", patientStatus.getBpDiaValue());
        values.put("bpPulseFlag", patientStatus.getBpPulseFlag());
        values.put("bpPulseValue", patientStatus.getBpPulseValue());
        values.put("weightFlag", patientStatus.getWeightFlag());
        values.put("weightValue", patientStatus.getWeightValue());
        values.put("oxiPulseFlag", patientStatus.getOxiPulseFlag());
        values.put("oxiPulseValue", patientStatus.getOxiPulseValue());
        values.put("oxiSpO2Flag", patientStatus.getOxiSpO2Flag());
        values.put("oxiPulseO2Value", patientStatus.getOxiSpO2Value());
        values.put("overallFlag", patientStatus.getOverallFlag());
        values.put("statusMsg", patientStatus.getStatusMsg());*//*
        values.put("is_Submitted", false);
        values.put("is_Uploaded", false);

        database.insertWithOnConflict("programInfo", null, values,SQLiteDatabase.CONFLICT_REPLACE);
    }*/


    public void insertPatientStatus(PatientStatus patientStatus) {
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues values = new ContentValues();


        values.put("patient_id", patientStatus.getPatientId());
        values.put("hbFlag", patientStatus.getHbFlag());
        values.put("hbValue", patientStatus.getHbValue());
        values.put("bpFlag", patientStatus.getBpSysFlag());
        values.put("bpSysValue", patientStatus.getBpSysValue());
       // values.put("bpDiaValue", patientStatus.getBpDiaFlag());
        ...
        values.put("overallFlag", patientStatus.getOverallFlag());
        values.put("statusMsg", patientStatus.getStatusMsg());
        values.put("is_Edited", false);
        values.put("is_Uploaded", false);

        database.insertWithOnConflict("patientSeverityStatus", null, values,SQLiteDatabase.CONFLICT_REPLACE);
    }
    public void loadPatientPersonalInfo(PatientPersonalInfo patientPersonalInfo, PatientAddressDetail addressDetail) {
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put("asha_id", patientPersonalInfo.getAsha_id());
        values.put("patient_id", patientPersonalInfo.getPatient_id());
        ...
        values.put("bp", patientPersonalInfo.getBp());
        values.put("hb", patientPersonalInfo.getHb());
        values.put("LMPDate", patientPersonalInfo.getLMPDate());
        values.put("EDDDate", patientPersonalInfo.getEDD());
    ...
    database.insertWithOnConflict("personalInfo", null, values,SQLiteDatabase.CONFLICT_REPLACE);
}
    ...
    public PatientPersonalInfo getPatient(String id) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                patientPersonalInfo.setEDD(cursor.getString(cursor.getColumnIndex("EDDDate")));

                patientPersonalInfo.setBp(cursor.getString(cursor.getColumnIndex("bp")));
                patientPersonalInfo.setHb(cursor.getString(cursor.getColumnIndex("hb")));
                patientPersonalInfo.setLMPDate(cursor.getString(cursor.getColumnIndex("LMPDate")));
