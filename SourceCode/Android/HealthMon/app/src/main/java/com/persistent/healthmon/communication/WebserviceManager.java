...
public class WebserviceManager {
    ...
    public static void getPatientsStauts(final Context context, String patientId)
    {
        ...
        StringRequest jsonObjRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            JSONArray jsonPatientInfos = new JSONArray(response.toString());
                            JSONObject jsonPatientStatus = jsonPatientInfos.getJSONObject(0);
                            PatientStatus patientStatus = new PatientStatus();
                            patientStatus.setPatientId(jsonPatientStatus.getString("Patient_id"));
                            patientStatus.setHbFlag(jsonPatientStatus.getInt("HBFlag"));
                            patientStatus.setHbValue(jsonPatientStatus.getDouble("HBValue"));
                            patientStatus.setBpSysFlag(jsonPatientStatus.getInt("BPSysFlag"));
                            patientStatus.setBpSysValue(jsonPatientStatus.getInt("BPSysValue"));
                            patientStatus.setBpDiaFlag(jsonPatientStatus.getInt("BPDiaFlag"));
                            patientStatus.setBpDiaValue(jsonPatientStatus.getInt("BPDiaValue"));
                            patientStatus.setBpPulseFlag(jsonPatientStatus.getInt("BPPulseFlag"));
                            patientStatus.setBpPulseValue(jsonPatientStatus.getInt("BPPulseValue"));
                            patientStatus.setWeightFlag(jsonPatientStatus.getInt("WeightFlag"));
                            patientStatus.setWeightValue(jsonPatientStatus.getDouble("WeightValue"));
                            patientStatus.setOxiPulseFlag(jsonPatientStatus.getInt("OxyPulseFlag"));
                            patientStatus.setOxiPulseValue(jsonPatientStatus.getInt("OxyPulseValue"));
                            patientStatus.setOxiSpO2Flag(jsonPatientStatus.getInt("OxiSpO2Flag"));
                            patientStatus.setOxiSpO2Value(jsonPatientStatus.getInt("OxiPulseO2Value"));
                            patientStatus.setOverallFlag(jsonPatientStatus.getInt("OverallFlag"));
                            patientStatus.setStatusMsg(jsonPatientStatus.getString("OverAllStatus"));

                            DatabaseHelper.getInstance(context).insertPatientStatus(patientStatus);
    ...
    public static void getPatientProgramInfo(final Context context, String patientId)
    {

        StringRequest jsonObjRequest = new StringRequest(Request.Method.GET,
                Constants.BASE_URL + Constants.GET_PATIENT_PROGRAM_URL + patientId,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<jsonPatientInfos.length();i++) {
                                JSONObject jsonPatientprogram = jsonPatientInfos.getJSONObject(i);

                                ProgramInfo programInfo = new ProgramInfo();
                             //   programInfo.setPatientId(jsonPatientprogram.getInt("Patient_id"));
                                programInfo.setProgram_id(jsonPatientprogram.getString("Programs_id"));
                                //programInfo.setHbValue(jsonPatientprogram.getInt("Program_Details_id"));
                                programInfo.setPatientId(jsonPatientprogram.getString("Patient_id"));
                            /*    programInfo.setBpSysValue(jsonPatientprogram.getInt("Program_item_id"));
                                programInfo.setBpDiaFlag(jsonPatientprogram.getString("Program_item_value"));
                                programInfo.setBpDiaValue(jsonPatientprogram.getString("Created_Date"));
                                programInfo.setBpPulseFlag(jsonPatientprogram.getString("Updated_Date"));
                                programInfo.setBpPulseValue(jsonPatientprogram.getString("Created_By"));
                                programInfo.setWeightFlag(jsonPatientprogram.getString("Updated_By"));
                                programInfo.setWeightValue(jsonPatientprogram.getString("Program_desc"));*/
                                programInfo.setIs_Uploaded(false);
                                programInfo.setIs_Submitted(false);


                                DatabaseHelper.getInstance(context).insertPatientProgramInfo(programInfo);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    public static void getAllPatientPersonalInfo(final Context context) {

        final ArrayList<PatientPersonalInfo> patientPersonalInfos = new ArrayList<PatientPersonalInfo>();


        StringRequest jsonObjRequest = new StringRequest(Request.Method.GET,
                Constants.BASE_URL + Constants.GET_ALL_PATIENTS_URL + PreferanceManager.getAshaId(context),
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        boolean isNewActivity = false;
                        ...
                        try {
                            JSONArray jsonPatientInfos = new JSONArray(response.toString());
                            for (int i = 0; i < jsonPatientInfos.length(); i++) {
                                JSONObject jsonPatientInfo = jsonPatientInfos.getJSONObject(i);
                                PatientPersonalInfo patientPersonalInfo = new PatientPersonalInfo();

                                patientPersonalInfo.setAsha_id(PreferanceManager.getAshaId(context));
                                patientPersonalInfo.setPatient_id(jsonPatientInfo.getString("Patient_id"));
                                patientPersonalInfo.setPatient_image_string(jsonPatientInfo.getString("Patient_Image"));
                                patientPersonalInfo.setSalutation(jsonPatientInfo.getString("Patient_Salutation"));
                                patientPersonalInfo.setFirstName(jsonPatientInfo.getString("Patient_FName"));
                                patientPersonalInfo.setMiddleName(jsonPatientInfo.getString("Patient_MName"));
                                patientPersonalInfo.setLastName(jsonPatientInfo.getString("Patient_LName"));
                                patientPersonalInfo.setGenderId(jsonPatientInfo.getInt("Gender_Id"));
                                patientPersonalInfo.setDob(jsonPatientInfo.getString("Patient_DOB"));
                                patientPersonalInfo.setAge(jsonPatientInfo.getInt("Patient_Age"));
                                patientPersonalInfo.setPlace_of_birth(jsonPatientInfo.getString("Patient_POB"));
                                patientPersonalInfo.setMarrital_status(jsonPatientInfo.getString("Patient_Marital_Status"));
                                patientPersonalInfo.setCategoryId(jsonPatientInfo.getInt("Cast_Category_Id"));

                                patientPersonalInfo.setBpl((jsonPatientInfo.getInt("Patient_BPL")==1?true:false));

                                patientPersonalInfo.setLanguage(jsonPatientInfo.getString("Patient_Language"));
                                patientPersonalInfo.setEducation(jsonPatientInfo.getString("Education"));
                                patientPersonalInfo.setIdCardTypeId(jsonPatientInfo.getInt("Card_Type_id"));
                                patientPersonalInfo.setIdCardNumber(jsonPatientInfo.getString("Card_Number"));
                                patientPersonalInfo.setContact(jsonPatientInfo.getString("Patient_Contact"));
                                patientPersonalInfo.setEm_contact(jsonPatientInfo.getString("Patient_Emergency_number"));
                                patientPersonalInfo.setPriority(jsonPatientInfo.getInt("OverallFlag"));
                                patientPersonalInfo.setEDD(jsonPatientInfo.getString("EDD"));
                                patientPersonalInfo.setTimeStamp(jsonPatientInfo.getString("Created_Date"));


                                patientPersonalInfo.setLMPDate(jsonPatientInfo.getString("LMPDate"));
                                patientPersonalInfo.setHb(jsonPatientInfo.getString("hb"));
                                patientPersonalInfo.setBp(jsonPatientInfo.getString("bp"));
                                ...
                                patientAddressDetail.setAddr1(jsonPatientInfo.getString("Address_line1"));
                                patientAddressDetail.setAddr2(jsonPatientInfo.getString("Address_line2"));
                                patientAddressDetail.setDistrictId(jsonPatientInfo.getInt("District_id"));
                                patientAddressDetail.setTalId(jsonPatientInfo.getInt("City_id"));
                                patientAddressDetail.setVillageId(jsonPatientInfo.getInt("Village_id"));
                                patientAddressDetail.setWard(jsonPatientInfo.getString("Patient_Ward"));
                                patientAddressDetail.setPin(jsonPatientInfo.getString("PinCode"));
                                patientAddressDetail.setIs_Submitted(false);
                                patientAddressDetail.setIs_Uploaded(false);
                                ...
                                DatabaseHelper.getInstance(context).loadPatientPersonalInfo(patientPersonalInfo,patientAddressDetail);
                                getPatientsStauts(context,patientPersonalInfo.getPatient_id());
                                getPatientProgramInfo(context,patientPersonalInfo.getPatient_id());
                               /* if (isNewActivity)
                                    //send request for inserting android id
                                    insertMyActivityAndroidId(context, myActivity);*/
                            }
