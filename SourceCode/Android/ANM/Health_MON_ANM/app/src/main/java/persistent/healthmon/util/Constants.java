...
public class Constants {
    ...
    public static final String BASE_URL_34_211 = "http://10.88.34.211:4300/";
    ...
    public static final String INSERT_MY_ACTIVITY_URL = "common/setMyActivities/";
    ...
    public static final String GET_FEEDBACK_QUESTIONS_URL = "patient/getSurveyTemplate/1/feedback/ANM";
    public static final String GET_HRA_QUESTIONS_URL = "patient/getSurveyTemplate/1/hra/ANM";
    ...
    public static final String GET_ALL_PATIENT_URL = "common/getPatientList/";
    public static final String GET_ALL_MO_URL = "common/getMoUserList";
    public static final String ADD_MO_APPOINTMENT_URL = "common/addAppointments";
    ...
    public class DbConstants {
        //care plan template
        public static final String TABLE_CAREPLAN_TEMPLATE = "careplantemplate";
        ...
        public static final String COLUMN_CAREPLAN_PATIENT_ID = "patientid";
        public static final String TABLE_PATIENT_CAREPLAN = "careplandetails";
        ...
        public static final String COLUMN_ASHA_ID = "HM_User_id";
        ...
        public static final String COLUMN_USER_ID = "HM_User_id";
        ...
        public static final String COLUMN_PATIENT_ID = "HM_Patient_id";
        ...
        public static final String COLUMN_LEARNING_ID = "hm_learning_id";
        public static final String COLUMN_PROGRAM_id = "hm_program_id";
        public static final String COLUMN_LEARNING_TTPE = "hm_learning_type";
        public static final String COLUMN_LEARNING_DESCRIPTION = "hm_learning_description";
        public static final String COLUMN_CONTENT_TYPE = "hm_learning_content_type";
        public static final String COLUMN_CREATION_DATE = "hm_learning_created_date";
        public static final String COLUMN_LEARNING_LINK = "hm_learning_link";
        public static final String COLUMNN_USER_ID = "hm_user_id";
        public static final String COLUMN_USER_TYPE = "hm_learning_for_user_type";
        public static final String COLUMN_LEARNING_IS_INTERNAL = "hm_learning_is_internal";
        public static final String COLUMN_PROGRAM_DESC = "hm_program_desc";
        public static final String COLUMN_ACTIVE = "hm_learning_active";
        ...
        public static final String TABLE_MO_MASTER = "MOMaster";
        ...
        public static final String MO_PHC_ID = "MO_PHC_Id";
        public static final String MO_NAME = "MO_Name";
        public static final String MO_QUALIFICATION = "MO_Qualification";
    ...
    //Patient selected
    public static String KEY_PATIENT_SELECTED = "PATIENT_SELECTED";
    ...
    public static final String PARAM_ACTIVITY = "Category_Desc";
    public static final String PARAM_TASK = "Template_Task_Desc";
    public static final String PARAM_FREQUENCY = "Frequency_Desc";
    public static final String PARAM_ROLE = "role";
    public static final String PARAM_IS_APPROVED = "Approved";
    public static final String PARAM_CREATED_BY = "Created_By";
    public static final String PARAM_UPDATED_BY = "Updated_By";
    public static final String PARAM_CREATED_DATE = "Created_Date";
    public static final String PARAM_UPDATED_DATE = "Updated_Date";
    public static final String PARAM_MEDICINE_GIVEN_BY = "MedicineGivenBy_User_Name";
    public static final String DATE_FORMAT = "yyyy-MM-dd HH:mm:SS";
    public static final String GET_CARE_PLAN_URL = "common/getPatientCareplan/";
    public static final String GET_CARE_TEMPLATES_URL = "common/getAllCareplanTemplates";
    public static final String INSERT_MY_IMMUNIZATIONS_URL = "common/setMedicationGivenBy";
    public static final String CARE_PLAN_SEND_TO_APPROVAL_URL = "common/setPatientCareplan/";
