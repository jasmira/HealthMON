 ...
 */
public class ANCProgFragment extends Fragment implements View.OnClickListener {
    RadioGroup radioGroupPregnancy;
    RelativeLayout llPrgnancyOption;
    Spinner spinnerDeliveryNature;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.program_anc_tamplate, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        if (PreferanceManager.getIsRegistrationSessionStored(getActivity())) {
            ...
            if (programInfo != null) {
                ...
                edtNotes.setText(programInfo.getNotes().toString());
            }
        }
    }
    ...
    private void performSave() {
        ...
        programInfo.setProgram_name(getActivity().getResources().getString(R.string.txtAnteNatalCare));
        programInfo.setProgram_id("1");
