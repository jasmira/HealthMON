...
import persistent.healthmon.util.Encrypt_Digest;
 ...
 */
public class LoginActivity extends Activity implements OnClickListener, LoginData {
    ...
    protected void onResume() {
        super.onResume();
        if (HealthMonUtility.isTablet(LoginActivity.this)) {
    ...
    public void onData(String response) {
        try {
            ...
            HealthMonLog.i("Login", "Login Response = " + result.toString() + "    ,  In String =  " + response);
            ...
            if (authorize.equalsIgnoreCase("false")) {
                ...
                HealthMonUtility.showErrorDialog(LoginActivity.this, getResources().getString(R.string.msgLoginErrorInvalidCredential));
            } else {
                ...
                //WebserviceManager.getLoginTaskDetails(LoginActivity.this);
                //WebserviceManager.getAshaDetails(LoginActivity.this);
                //requesting call mater data
                getMasterData();
                if (DatabaseHelper.getInstance(this).getCarePlanTemplates() == null) {
                    WebserviceManager.getCarePlanTemplates(this);
                }
    ...
    private void getMasterData() {
        ...
        WebserviceManager.getMedicationMaster(LoginActivity.this);
        WebserviceManager.getAllMO(LoginActivity.this);
    }
    ...
    public void onError(VolleyError error) {
        ...
        if (error instanceof NoConnectionError)
            HealthMonUtility.showErrorDialog(LoginActivity.this, getResources().getString(R.string.msgErrorNoInternet));
        else
            HealthMonUtility.showErrorDialog(LoginActivity.this, getResources().getString(R.string.msgLoginErrorInvalidCredential));
    }
}
