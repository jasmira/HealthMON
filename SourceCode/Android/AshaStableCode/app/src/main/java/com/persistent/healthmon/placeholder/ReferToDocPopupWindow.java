 ...
 */
public class ReferToDocPopupWindow extends android.widget.PopupWindow {
    Context ctx;
    Button btnDismiss;
    TextView lblText;
    ImageView imageView;
    ...
    public ReferToDocPopupWindow(Context context) {
        super(context);
        ...
        imageView.setImageDrawable(ctx.getResources().getDrawable(R.drawable.diet_during_pregnancy));
        setHeight(600);
        setWidth(1000);
