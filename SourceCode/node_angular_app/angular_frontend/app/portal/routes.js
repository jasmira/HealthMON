angular.module('healthMon').config(function($stateProvider, $urlRouterProvider,PATH) {
	...
	.state('reports', {
            url: '/reports',
            templateUrl: '/static/'+PATH.reportsViews+'/reports.html',
            controller: "reportsCtrl",
            controllerAs: "reportsCtrl",
            authenticated : true
        })
    .state('reports.anemiaPatientTrends', {
            url: '/anemiaPatientTrends',
            templateUrl: '/static/'+PATH.reportsViews+'/anemiaPatientTrends.html',
            controller: "anemiaPatientTrendsCtrl",
            controllerAs: "anemiaPatientTrendsCtrl",
            authenticated : true
        })
    .state('reports.enrolledBenificiaries', {
            url: '/enrolledBenificiaries',
            templateUrl: '/static/'+PATH.reportsViews+'/enrolledBenificiaries.html',
            controller: "enrolledBenificiariesCtrl",
            controllerAs: "enrolledBenificiariesCtrl",
            authenticated : true
        })
    .state('reports.healthStatusTrend', {
            url: '/healthStatusTrend',
            templateUrl: '/static/'+PATH.reportsViews+'/healthStatusTrend.html',
            controller: "healthStatusTrendCtrl",
            controllerAs: "healthStatusTrendCtrl",
            authenticated : true
        })
    .state('reports.healthStatusOfBenificiary', {
            url: '/healthStatusOfBenificiary',
            templateUrl: '/static/'+PATH.reportsViews+'/healthStatusOfBenificiary.html',
            controller: "healthStatusOfBenificiaryCtrl",
            controllerAs: "healthStatusOfBenificiaryCtrl",
            authenticated : true
        })
    .state('reports.referalCases', {
            url: '/referalCases',
            templateUrl: '/static/'+PATH.reportsViews+'/referalCases.html',
            controller: "referalCasesCtrl",
            controllerAs: "referalCasesCtrl",
            authenticated : true
        })
    .state('reports.performanceOfTeamMembers', {
            url: '/performanceOfTeamMembers',
            templateUrl: '/static/'+PATH.reportsViews+'/performanceOfTeamMembers.html',
            controller: "performanceOfTeamMembersCtrl",
            controllerAs: "performanceOfTeamMembersCtrl",
            authenticated : true
        })
    .state('reports.missedRecordTrends', {
            url: '/missedRecordTrends',
            templateUrl: '/static/'+PATH.reportsViews+'/missedRecordTrends.html',
            controller: "missedRecordTrendsCtrl",
            controllerAs: "missedRecordTrendsCtrl",
            authenticated : true
        })
        .state('calendar', {
            url: '/calendar',
      ...
      .state('newActivity.selfActivity', {
       ...
       .state('patientCareplan', {
		...
		.state('patientCareplan.patientSummary.outcome', {
            url: '/outcome',
            templateUrl: '/static/'+PATH.allPatientViews+'/PatientsCarePlans/partial-patientSummary-outcome.html',
            controller: "patientOutcomeCtrl",
            controllerAs: "patientOutcomeCtrl",
            authenticated : true
        })
